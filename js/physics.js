...
const Physics = {
  ...
  updateBall: function(deltaTime) {
    ...
    const newX = Game.ball.position.x + 
        let velocityX = Game.ball.userData.velocity.x;
        let velocityY = Game.ball.userData.velocity.y;

        // Ensure Y velocity is within a balanced range to avoid excessive bouncing
        ...
        // Apply new velocity
        Game.ball.userData.velocity.x = velocityX;
